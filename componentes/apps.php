...
$paginaActual = basename($_SERVER['PHP_SELF'] ?? 'apps.php');
$db->cerrar();
?>
<!doctype html>
<html lang="es">
...
<body>
    ...
    <div class="container topbar__inner">
      ...
      <nav class="topbar__nav">
        <?php if (empty($menusCabecera)): ?>
          ...
          <a class="navlink is-active" href="apps.php">Apps</a>
  ...
  <main class="container">
    <section class="panel">
      <h1>Apps</h1>
      <p>Aqui puedes mostrar el listado de aplicaciones y accesos directos.</p>
    </section>
  </main>
